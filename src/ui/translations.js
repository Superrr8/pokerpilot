...
(function attachLocalization(root) {
  ...
  const PAIRS = Object.freeze({
    ...
    'onboarding.legal.termsPending': ['The final Terms of Use destination and production legal content remain a pre-release dependency.', 'Финальная ссылка и полная редакция Условий использования остаются зависимостью до публичного релиза.'],
    'onboarding.legal.privacyPending': ['The final Privacy Policy destination and production legal content remain a pre-release dependency.', 'Финальная ссылка и полная редакция Политики конфиденциальности остаются зависимостью до публичного релиза.'],
