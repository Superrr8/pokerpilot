...
(function attachLocalization(root) {
  ...
  const PAIRS = Object.freeze({
    ...
    'onboarding.welcome.eyebrow': ['Welcome to PokerElevate', 'Добро пожаловать в PokerElevate'],
    'onboarding.welcome.title': ['Train better poker decisions.', 'Тренируйте сильные покерные решения.'],
    'onboarding.welcome.body': ['PokerElevate helps you practice the decisions that shape every hand.', 'PokerElevate помогает тренировать решения, от которых зависит каждая раздача.'],
    'onboarding.welcome.detail': ['A short 10-decision assessment will personalize your starting path. It takes about 3–5 minutes.', 'Короткая оценка из 10 решений персонализирует ваш стартовый маршрут. Это займёт около 3–5 минут.'],
    'onboarding.welcome.start': ['Begin assessment', 'Начать оценку'],
    'onboarding.consent.eyebrow': ['Responsible play', 'Ответственная игра'],
    'onboarding.consent.title': ['Know what training can — and cannot — do.', 'Понимайте возможности и ограничения тренировки.'],
    'onboarding.consent.body': ['PokerElevate is an educational and training tool. Poker involves skill, chance, and financial risk. Training, analysis, and recommendations do not guarantee winnings or profits. PokerElevate does not offer or facilitate real-money gambling. You are responsible for your own playing decisions and for following applicable laws and the rules of any venue or platform where you play.', 'PokerElevate — образовательный и тренировочный инструмент. Покер сочетает мастерство, случайность и финансовый риск. Тренировки, анализ и рекомендации не гарантируют выигрышей или прибыли. PokerElevate не предлагает и не организует азартные игры на реальные деньги. Вы сами отвечаете за свои игровые решения, соблюдение применимых законов и правил площадки или заведения, где играете.'],
    'onboarding.consent.agree': ['I understand and agree to the Terms of Use and Privacy Policy.', 'Я понимаю и принимаю Условия использования и Политику конфиденциальности.'],
    'onboarding.consent.terms': ['Terms of Use', 'Условия использования'],
    'onboarding.consent.privacy': ['Privacy Policy', 'Политика конфиденциальности'],
    'onboarding.consent.continue': ['Continue to assessment', 'Перейти к оценке'],
    'onboarding.consent.back': ['Back to welcome', 'Вернуться к приветствию'],
    'onboarding.reconsent.eyebrow': ['Legal update', 'Обновление документов'],
    'onboarding.reconsent.title': ['Review the current legal documents.', 'Ознакомьтесь с актуальными документами.'],
    'onboarding.reconsent.body': ['Your progress is safe. To continue, review and accept the current Terms of Use and Privacy Policy. This does not repeat the skill assessment or change your PokerElevate progress.', 'Ваш прогресс сохранён. Чтобы продолжить, ознакомьтесь с актуальными Условиями использования и Политикой конфиденциальности и примите их. Это не запускает оценку навыков повторно и не меняет прогресс PokerElevate.'],
    'onboarding.reconsent.continue': ['Accept and continue', 'Принять и продолжить'],
    'onboarding.assessment.eyebrow': ['Initial skill assessment', 'Начальная оценка навыков'],
    'onboarding.assessment.progress': ['Decision {current} of {total}', 'Решение {current} из {total}'],
    'onboarding.assessment.prompt': ['What is your decision?', 'Какое решение вы выберете?'],
    'onboarding.assessment.position': ['Position', 'Позиция'],
    'onboarding.assessment.pot': ['Pot', 'Банк'],
    'onboarding.assessment.toCall': ['To call', 'К коллу'],
    'onboarding.assessment.stack': ['Effective stack', 'Эффективный стек'],
    'onboarding.result.eyebrow': ['Assessment complete', 'Оценка завершена'],
    'onboarding.result.title': ['Your starting path', 'Ваш стартовый маршрут'],
    'onboarding.result.pokerIq': ['Starting Poker IQ', 'Стартовый Poker IQ'],
    'onboarding.result.strengths': ['Current strengths', 'Текущие сильные стороны'],
    'onboarding.result.focus': ['Recommended focus', 'Рекомендуемый фокус'],
    'onboarding.result.start': ['Start training', 'Начать тренировку'],
    'onboarding.band.starter': ['Starter', 'Начинающий'],
    'onboarding.band.intermediate': ['Intermediate', 'Средний'],
    'onboarding.band.advanced': ['Advanced', 'Продвинутый'],
    'onboarding.band.expert': ['Expert', 'Эксперт'],
    'onboarding.skill.preflop': ['Preflop selection', 'Префлоп-решения'],
    'onboarding.skill.value': ['Value decisions', 'Вэлью-решения'],
    'onboarding.skill.bluffing': ['Bluff selection', 'Выбор блефов'],
    'onboarding.skill.discipline': ['Decision discipline', 'Дисциплина решений'],
    'onboarding.skill.pokerMath': ['Poker math', 'Покерная математика'],
    'onboarding.question.firstIn': ['Everyone folds to you at a $1/$3 6-max table.', 'Все игроки до вас выбросили карты за столом $1/$3 6-max.'],
    'onboarding.question.earlyOpen': ['UTG opens to $12. You are in the big blind.', 'UTG открывается до $12. Вы на большом блайнде.'],
    'onboarding.question.lateOpen': ['The button opens to $10. You are in the big blind.', 'Баттон открывается до $10. Вы на большом блайнде.'],
    'onboarding.question.facingThreeBet': ['You open to $12 from the cutoff and face a 3-bet to $38.', 'Вы открываетесь до $12 с катоффа и получаете 3-бет до $38.'],
    'onboarding.action.fold': ['Fold', 'Фолд'],
    'onboarding.action.check': ['Check', 'Чек'],
    'onboarding.action.call': ['Call', 'Колл'],
    'onboarding.action.bet': ['Bet', 'Ставка'],
    'onboarding.action.raise': ['Raise', 'Рейз'],
    'onboarding.action.allIn': ['All-in', 'Олл-ин'],
    'dashboard.assessmentNextEyebrow': ['YOUR PERSONALIZED START', 'ВАШ ПЕРСОНАЛЬНЫЙ СТАРТ'],
    'dashboard.assessmentNextTitle': ['Start with {focus}', 'Начните с темы «{focus}»'],
    'dashboard.assessmentNextDescription': ['Your initial assessment identified this as the highest-value place to begin.', 'Начальная оценка определила эту тему как самую полезную точку старта.'],
    'dashboard.assessmentNextMeta': ['5 decisions · about 5 minutes', '5 решений · около 5 минут'],
    'dashboard.assessmentNextAction': ['Start personalized training', 'Начать персональную тренировку'],
    ...
    'action.reset': ['Delete All Local Data', 'Удалить все локальные данные'],
    ...
    'compliance.eyebrow': ['LEGAL & PRIVACY', 'ПРАВО И КОНФИДЕНЦИАЛЬНОСТЬ'],
    'compliance.title': ['Release & data controls', 'Документы и управление данными'],
    'compliance.description': ['Review product terms, privacy, responsible-play limits, support, and local-data controls.', 'Просматривайте условия продукта, конфиденциальность, правила ответственной игры, поддержку и управление локальными данными.'],
    'compliance.terms': ['Terms of Use', 'Условия использования'],
    'compliance.termsDetail': ['Current version and permitted use', 'Актуальная версия и правила использования'],
    'compliance.privacy': ['Privacy Policy', 'Политика конфиденциальности'],
    'compliance.privacyDetail': ['Local storage, retention, and deletion', 'Локальное хранение, сроки и удаление'],
    'compliance.support': ['Support & Contact', 'Поддержка и контакты'],
    'compliance.supportDetail': ['Current support destination', 'Текущий канал поддержки'],
    'compliance.responsiblePlay': ['Educational Use & Responsible Play', 'Обучение и ответственная игра'],
    'compliance.responsiblePlayDetail': ['Training limits and financial-risk notice', 'Ограничения тренировки и финансовый риск'],
    'compliance.deleteData': ['Delete All Local Data', 'Удалить все локальные данные'],
    'compliance.deleteDataDetail': ['Reset PokerElevate to a clean first launch', 'Вернуть PokerElevate к чистому первому запуску'],
    'compliance.deleteConfirm': ['Delete all PokerElevate data stored on this device? This removes your profile, progress, saved hands, assessment, preferences, and legal acceptance. This cannot be undone.', 'Удалить все данные PokerElevate на этом устройстве? Будут удалены профиль, прогресс, сохранённые раздачи, оценка навыков, настройки и принятие документов. Это действие нельзя отменить.'],
    'compliance.deleteFailed': ['PokerElevate could not remove all local data. No reload was performed.', 'PokerElevate не удалось удалить все локальные данные. Перезагрузка не выполнена.'],
    'compliance.version': ['Version {version}', 'Версия {version}'],
    'compliance.effectiveDate': ['Effective {date}', 'Действует с {date}'],
    'compliance.openDestination': ['Open official document', 'Открыть официальный документ'],
    ...
    'daily.correct': ['Correct', 'Правильно'],
    'daily.incorrect': ['Incorrect', 'Ошибка'],
    'daily.correctDecision': ['Correct decision', 'Правильное решение'],
    'daily.resultWithXp': ['{outcome} · +{xp} XP', '{outcome} · +{xp} XP'],
    'daily.answerSaved': ['Answer saved: {action}', 'Ответ сохранён: {action}'],
    'daily.actionSelected': ['Selected: {action}', 'Выбрано: {action}'],
    'daily.handComplete': ['Hand complete', 'Раздача завершена'],
    'daily.streak': ['Daily Hand streak: {count} {unit}', 'Серия раздачи дня: {count} {unit}'],
    'daily.dayOne': ['day', 'день'],
    'daily.dayFew': ['days', 'дня'],
    'daily.dayMany': ['days', 'дней'],
    ...
    'live.youWin': ['You win', 'Ты выигрываешь'],
    'live.playerTakesPot': ['{player} takes the pot', 'Банк забирает {player}'],
    'live.potAwarded': ['Pot awarded', 'Банк присуждён'],
    'live.potAwardSummary': ['{reason} {winner}: {amount}.', '{reason} {winner}: {amount}.'],
    'live.uncontestedPlayerPot': ['The remaining opponents folded. {player} takes the pot: {amount}.', 'Остальные соперники выбросили карты. Банк забирает {player}: {amount}.'],
    'live.reason.openingRange': ['{hand} is in the learning opening range from {position}.', '{hand} входит в учебный диапазон открытия из {position}.'],
    'live.reason.isolationRange': ['{hand} is in the learning isolation range from {position}.', '{hand} входит в учебный диапазон изоляции из {position}.'],
    'live.reason.weakNineMax': ['{hand} is usually too weak from {position} in the baseline 9-max live model.', '{hand} обычно слишком слаба из {position} в базовой 9-max live-модели.'],
    'live.reason.bbFreeFlop': ['The BB can see the flop for free.', 'На BB можно бесплатно увидеть флоп.'],
    'live.reason.threeBetRange': ['The hand is in the baseline 3-bet range.', 'Рука входит в базовый 3-бет диапазон.'],
    'live.reason.conditionalContinue': ['The hand is strong enough to continue, but the exact line depends on position and opponent type.', 'Рука достаточно сильна для продолжения, но точная линия зависит от позиции и типа соперника.'],
    'live.reason.outsideContinue': ['The hand is not in the baseline continuing range.', 'Рука не входит в базовый диапазон продолжения.'],
    'live.reason.equityCall': ['Equity {equity}; required {required}. Edge: {edge} pp.{outs}', 'Эквити {equity}, минимально нужно {required}. Запас: {edge} п.п.{outs}'],
    'live.reason.outs': [' Strong outs: {strong}; conditional: {conditional}.', ' Сильных аутов: {strong}; условных: {conditional}.'],
    'live.reason.madeHand': ['Made hand: {hand}. Equity against the modeled range: {equity}.{outs}', 'Готовая комбинация: {hand}. Эквити против модели диапазона: {equity}.{outs}'],
    'live.reason.strongOuts': [' Strong outs: {count}.', ' Сильных аутов: {count}.'],
    'handReview.handStrength': ['Hand strength', 'Сила руки'],
    'handReview.position': ['Position', 'Позиция'],
    'handReview.preflopRecommendation': ['The preflop recommendation is based on position, prior action, and baseline $1/$3 live ranges.', 'Префлоп-рекомендация строится по позиции, действиям до тебя и базовым live-диапазонам $1/$3.'],
